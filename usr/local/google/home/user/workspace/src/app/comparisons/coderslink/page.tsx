...
const comparisonPoints = {
  Vetting: {
    ...
    teamstation:
      "Our Axiom Cortex™ provides scientific proof of a candidate's problem-solving ability, not just their credentials. We de-risk the hiring decision with data.",
  ...
  Operations: {
    ...
    teamstation:
      "Our integrated platform is a complete operational wrapper. We bundle all services under a single, accountable SLA, so you can focus on your product.",
    proof: "1 accountable SLA",
  },
  Cost: {
    pain: "Are you seeing the full picture on cost?",
    traditional:
      "The placement fee or hourly rate hides the significant 'hidden costs' of managing your own legal, IT, and compliance for a remote team.",
    teamstation:
      "Our all-inclusive pricing provides a predictable, CFO-ready TCO that is often 40-60% lower than the fully-loaded cost of other models.",
      ...
      <main className="container py-12">
        ...
        <header className="text-center my-8">
          <h1 className="text-4xl font-extrabold tracking-tight md:text-5xl bg-gradient-to-r from-primary to-blue-400 bg-clip-text text-transparent">
            TeamStation AI vs. {competitor.name}
          </h1>
          <p className="mt-4 max-w-3xl mx-auto text-lg text-muted-foreground">
            A comparison between TeamStation AI’s integrated platform and{" "}
            {competitor.name}’s recruitment marketplace model.
          </p>
          <div className="mt-4 text-sm">
            ...
            >
              Vendor home: {new URL(competitor.url).hostname}{" "}
        ...
        <div className="my-12">
          <h2 className="text-3xl font-bold text-center">
            The Integrated Platform vs. The Recruitment Marketplace
          </h2>
        ...
        <div className="prose dark:prose-invert mx-auto my-12 max-w-4xl">
          <h2 className="text-center">
            Analysis: The Integrated Platform vs. The Marketplace
          </h2>
          <p>
            {competitor.name} operates as a recruitment marketplace for LATAM
            talent, effective for sourcing candidates. However, this model
            places the significant burden of compliance, payroll, device
            security, and HR management on the client.
          </p>
          <p>
            As a {competitor.name} alternative, TeamStation AI provides a fully
            integrated platform. We don't just find talent; we provide the
            entire operational infrastructure. This includes EOR, secure
            MDM-managed devices, and comprehensive insurance, all bundled into a
            single, predictable rate.
          </p>
        </div>
        ...
        <div className="text-center rounded-lg bg-primary/10 p-8 shadow-lg">
          ...
          <p className="mt-2 mx-auto max-w-2xl text-muted-foreground">
            If you have the internal resources to manage international hiring,
            compliance, and IT security, a marketplace like {competitor.name}{" "}
            can be a good sourcing tool. For companies seeking a complete,
            secure, and scalable solution that reduces risk and operational
            burden, TeamStation AI's integrated platform offers a clear
            advantage.
          </p>
