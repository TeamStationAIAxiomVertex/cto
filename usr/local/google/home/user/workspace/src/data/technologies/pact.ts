...
const pact: TechEntry = {
    ...
    intro: "Pact is the leading framework for **Consumer-Driven Contract Testing**, ensuring that services (e.g., an API provider and a client) can evolve independently without breaking integrations. You need an engineer who understands that reliable microservices aren't just about unit tests, but about guaranteeing the contract between services. Our vetting process identifies developers who are experts in implementing Pact, defining clear consumer expectations, and integrating contract testing into the CI/CD pipeline. By hiring a Pact expert, you get a developer who can eliminate costly, slow, and flaky end-to-end integration tests, and dramatically increase your confidence in deploying microservices independently.",
    pains: [
        {
            icon: AlertTriangle,
