...
import { NAV, simpleNavItems } from "../../../../../../../../../src/config/nav";
import {
  Accordion,
  AccordionContent,
  AccordionItem,
  ...
  return (
    <div className="md:hidden">
      <button
        ...
        className="inline-flex h-10 w-10 items-center justify-center rounded-md border bg-transparent text-muted-foreground"
