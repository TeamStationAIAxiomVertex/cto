    ...
    <section className="my-16 rounded-xl border bg-card p-6 md:p-8 shadow-lg" id="comparison-widget">
      ...
      <div className="mt-6 flex flex-wrap justify-center items-center gap-x-6 gap-y-4 rounded-lg bg-background p-4 border text-sm">
        <div className="flex items-center gap-2">
          <WithTooltip content={<span >The number of billable hours per month. 173 is standard for full-time.</span>}>
         ...
         <div className="flex items-center gap-2">
          <WithTooltip content={<span >Your blended engineering cost per hour, used for calculating latency and rework costs.</span>}>
        ...
        <div className="flex items-center gap-2">
          <WithTooltip content={<span >Estimated management and administrative overhead for onshore vendors.</span>}>
            <label
        ...
        <div className="flex items-center gap-2">
          <WithTooltip content={<span >Estimated management, communication, and rework overhead for offshore vendors.</span>}>
            <label
        ...
        <div className="flex items-center gap-2">
          <WithTooltip content={<span >Estimated management and administrative overhead for legacy nearshore vendors.</span>}>
            <label
          ...
          <tbody className="divide-y divide-border">
            {rows.map((row) => (
              <tr key={row.label} className="hover:bg-background/50">
                ...
                >
                  <WithTooltip content={<span >{row.description}</span>}>
