...
import { comparisonPages } from "../../../../../../../../src/lib/comparisonPages";
...
export async function collectCoreUrls(): Promise<SitemapUrl[]> {
  const urls: SitemapUrl[] = [
    ...
    {
      loc: `${BASE_URL}/hire/by-role`,
      lastmod: new Date().toISOString(),
      changefreq: "monthly",
      priority: 0.8,
    },
    {
      loc: `${BASE_URL}/hire/by-technology`,
      lastmod: new Date().toISOString(),
      changefreq: "monthly",
      priority: 0.8,
    },
    {
      loc: `${BASE_URL}/hire/by-country`,
      lastmod: new Date().toISOString(),
      changefreq: "monthly",
      priority: 0.8,
    },
    {
      loc: `${BASE_URL}/hire/by-team-topologies`,
      lastmod: new Date().toISOString(),
      changefreq: "monthly",
      priority: 0.8,
    },
