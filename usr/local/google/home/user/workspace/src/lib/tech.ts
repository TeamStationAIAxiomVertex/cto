...
export function getAllTechSlugs(): string[] {
    return techCategories.flatMap(category => category.tech.map(tech => tech.slug));
}

```
  </change>
  <change>
    <file>/usr/local/google/home/user/workspace/src/app/comparisons/revelo/page.tsx</file>
    <content><![CDATA[
