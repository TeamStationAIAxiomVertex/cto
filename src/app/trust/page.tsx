...
const msaSections = [
  ...
  },
  {
    ...
    content: `
      <h4 class="h4">2.1 Initial Term</h4>
      <p>This Agreement shall commence on the Effective Date and shall remain in effect for a period of one (1) year, unless terminated earlier in accordance with the terms herein (the “Initial Term”).</p>
      <h4 class="h4">2.2 Renewal Term</h4>
      <p>Upon the expiration of the Initial Term, this Agreement shall automatically renew for additional twelve (12)-month periods (each, a “Renewal Term”), unless either Party provides written notice of its intent not to renew at least thirty (30) days prior to the end of the then-current term.</p>
    `,
  },
  {
    ...
    content: `
      <h4 class="h4">3.1 Fees and Billing</h4>
      <p>Customer shall compensate Contractor for the Nearshore IT Staff Augmentation Services provided under this Agreement as specified in each applicable Statement of Work (SOW). Fees shall be based on one or more of the following pricing structures: Hourly Rate – Based on the actual hours worked by Assigned Personnel, tracked and reported per the terms of the applicable SOW. Fixed Monthly Rate – A set fee per Assigned Personnel per month, as outlined in the applicable SOW.</p>
      <h4 class="h4">3.2 Invoicing</h4>
      <p>Contractor shall submit invoices to Customer on a monthly basis, unless otherwise specified in an SOW. Each invoice shall include: The name and role of Assigned Personnel, The billing period covered by the invoice, The total hours worked (if applicable), The total amount due.</p>
      <h4 class="h4">3.3 Payment Terms</h4>
      <p>Customer shall remit payment within [thirty (30) days] from the date of receipt of a valid invoice (“Net 30”). Payments shall be made via electronic funds transfer (EFT), wire transfer, or another mutually agreed-upon payment method.</p>
      <h4 class="h4">3.4 Late Payments</h4>
      <p>If any invoice remains unpaid beyond five (5) business days after the due date, Contractor reserves the right to: Charge a late fee of 1.5% per month (or the maximum legal interest rate) on outstanding balances. Suspend Assigned Personnel’s services until payment is received.</p>
    `,
  },
  {
    ...
    content: `
      <h4 class="h4">5.1 Pre-Existing Intellectual Property</h4>
  ...
  },
  {
    ...
    content: `
      <h4 class="h4">6.1 Definition of Confidential Information</h4>
      ...
      <h4 class="h4">6.2 Obligations of Confidentiality</h4>
      <p>Each Party agrees to: Use Confidential Information only as necessary to fulfill its obligations under this Agreement. Not disclose Confidential Information to any third party without prior written consent. Take reasonable precautions to protect the confidentiality of disclosed information...</p>
      <h4 class="h4">6.5 Duration of Confidentiality Obligations</h4>
      <p>The obligations under this Confidentiality section shall remain in effect for a period of [three (3)] years after the termination of this Agreement.</p>
    `,
  },
   {
  ...
  },
  {
    ...
    content: `
      <h4 class="h4">9.1 Termination for Convenience</h4>
      <p>Either Party may terminate this Agreement or any active Statement of Work (SOW) for convenience by providing thirty (30) days’ prior written notice to the other Party.</p>
       <h4 class="h4">9.4 Personnel Placement and Support</h4>
      <p><strong>9.4b Performance Management and Resolution:</strong> Should Customer identify a significant and persistent performance deficiency... Contractor will... work collaboratively with Customer and the Personnel to understand the issues and develop a mutually agreeable performance improvement plan ("PIP")...</p>
      <p><strong>9.4c Replacement for Unsatisfactory Performance:</strong> If, despite the implementation of a PIP, the Personnel's performance does not improve... Contractor will, at Customer's request, initiate the process to replace the Personnel...</p>
      <p><strong>9.4d Early Departure or Unsuitability of Personnel:</strong> For the purposes of this section, an "Early Departure Period" shall be defined as the first sixty (60) calendar days... If Personnel voluntarily resigns, or if Contractor determines... that Personnel is not a suitable fit... during the Early Departure Period, Contractor will use commercially reasonable efforts to identify and propose suitable replacement Personnel as a top priority.</p>
    `,
  },
  {
    ...
    content: `
      <h4 class="h4">11.1 Required Insurance Coverage</h4>
      <p>Contractor shall maintain, at its own expense, during the term of this Agreement and any applicable SOWs, the following insurance coverage:</p>
      <ul>
  ...
  },
  {
    ...
    content: `
      <h4 class="h4">19.1 No Direct Hiring of Assigned Personnel</h4>
      ...
      <h4 class="h4">19.2 Liquidated Damages for Unauthorized Hiring</h4>
      <p>If Customer hires or engages any Assigned Personnel in violation of Section 19.1, Customer shall pay Contractor a placement fee equal to 30% of the Assigned Personnel’s annual bill rate, unless Customer elects to execute a contract purchase to avoid the penalty.</p>
      <h4 class="h4">19.3 Contract Purchase Option</h4>
      <p>To avoid the 30% annual bill rate placement fee, Customer may instead opt to purchase the contract by paying a one-time fee equivalent to three (3) months’ bill rate for the Assigned Personnel. This must be agreed upon in writing before the Assigned Personnel is hired.</p>
    `,
  },
];
