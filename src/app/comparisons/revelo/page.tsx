...
const comparisonPoints = {
    "Operations": {
        ...
        traditional: "Revelo combines a marketplace with <InfoDropdown title={<span class='border-b border-dashed'>EOR</span>}><p class='text-sm text-muted-foreground'>Employer of Record: a service that allows you to legally hire employees in other countries without setting up a local entity.</p></InfoDropdown>, which is a great start. However, secure device provisioning (<InfoDropdown title={<span class='border-b border-dashed'>MDM</span>}><p class='text-sm text-muted-foreground'>Mobile Device Management: software that secures, monitors, and manages devices like laptops.</p></InfoDropdown>) and insurance are not included, leaving a critical security and compliance gap.",
