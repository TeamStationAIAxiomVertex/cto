...
const takeaways = [
    ...
    { title: 'Cognitive AI & Fairness', description: 'Axiom Cortex uses 44 psychometric + NLP signals with language-fairness calibration to evaluate candidates, producing BARS-mapped and expert-reviewed scores. None of the other vendors disclose cognitive-science methods or fairness audits.' },
