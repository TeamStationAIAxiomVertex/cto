...
const comparisonPoints = {
    ...
    "Operations": {
        ...
        traditional: "Deel handles payroll and compliance. They do not provide or manage secure laptops, <a href='/trust' class='text-primary hover:underline'><span class='border-b border-dashed'>MDM</span></a>, or insurance. This is a major operational and security gap you must fill.",
        teamstation: "Our platform is a complete operational wrapper. We bundle <a href='/services/integrated-services' class='text-primary hover:underline'><span class='border-b border-dashed'>EOR</span></a>, MDM-secured devices, and insurance under one accountable SLA.",
  ...
  return (
    <main className="manual-page container py-10">
      ...
      <header className="glass-panel gradient-ring hero-depth system-grid text-center my-8 rounded-2xl p-6 md:p-8">
        <h1 className="text-4xl font-extrabold tracking-tight md:text-5xl text-foreground">TeamStation AI vs. Deel</h1>
