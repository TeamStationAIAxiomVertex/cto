...
const comparisonPoints = {
    ...
    "Operations": {
        ...
        traditional: "Andela's model leaves the client responsible for critical operational components like device security, <Tooltip text='Mobile Device Management: software that secures, monitors, and manages devices like laptops.'>MDM</Tooltip>, and insurance, creating hidden costs and risks.",
        teamstation: "Our integrated platform is <a href='/trust' class='text-primary hover:underline'>secure by default</a>. We bundle <Tooltip text='Employer of Record: a service that allows you to legally hire employees in other countries without setting up a local entity.'>EOR</Tooltip>, MDM-secured devices, and insurance under one SLA.",
