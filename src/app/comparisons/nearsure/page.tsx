...
const comparisonPoints = {
    "Operations": {
        ...
        traditional: "Nearsure is a recruiting partner. They find talent, but the client is left to manage compliant hiring (<InfoDropdown title={<span class='border-b border-dashed'>EOR</span>}><p class='text-sm text-muted-foreground'>Employer of Record: a service that allows you to legally hire employees in other countries without setting up a local entity.</p></InfoDropdown>), payroll, secure devices, and insurance.",
        teamstation: "We provide the complete, managed operating system. Our platform includes EOR, <InfoDropdown title={<span class='border-b border-dashed'>MDM</span>}><p class='text-sm text-muted-foreground'>Mobile Device Management: software that secures, monitors, and manages devices like laptops.</p></InfoDropdown>-secured devices, and insurance under a single, predictable SLA.",
  ...
  return (
    <main className="container py-12">
      ...
      <div className="prose dark:prose-invert mx-auto my-12 max-w-4xl">
        ...
        <p>
           Issues like compliant hiring (<InfoDropdown title={<span className="border-b border-dashed">EOR</span>}><p className="text-sm text-muted-foreground">Employer of Record: a service that allows you to legally hire employees in other countries without setting up a local entity.</p></InfoDropdown>), payroll, secure device management, and insurance are outside their scope. TeamStation AI was created to solve this exact problem. We provide an integrated platform that handles not only sourcing (powered by our{' '}
