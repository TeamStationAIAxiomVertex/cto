...
import { getComparisonData, getComparisonSlugs, generateVerdictRows, generateFaqSchema } from '@/lib/comparison-data';
...
export default async function ComparisonPage({ params }: { params: { vendor: string } }) {
  ...
  const verdictRows = generateVerdictRows(comparison_claims);
