...
const comparisonPoints = {
    ...
    "Operations": {
        ...
        traditional: "Like most traditional firms, their model leaves you to manage the critical and risky operational components: secure devices, <Tooltip text='Mobile Device Management: software that secures, monitors, and manages devices like laptops.'>MDM</Tooltip>, compliance, and insurance.",
        teamstation: "Our integrated platform absorbs all of this risk and complexity. We bundle <Tooltip text='Employer of Record: a service that allows you to legally hire employees in other countries without setting up a local entity.'>EOR</Tooltip>, secure devices, and insurance under one accountable SLA.",
