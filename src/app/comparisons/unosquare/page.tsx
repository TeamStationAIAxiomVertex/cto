...
const comparisonData = [
    ...
    { feature: 'Purpose-built for Integrated Teams', teamstation: true },
    { feature: 'Traditional Staff Aug & Project Consulting', competitor: true },
    { feature: 'Client handles compliance, security, devices', competitor: true },
];
