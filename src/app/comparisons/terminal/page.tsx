...
const comparisonPoints = {
    "Operations": {
        ...
        traditional: "Terminal is an <InfoDropdown title={<span class='border-b border-dashed'>EOR</span>}><p class='text-sm text-muted-foreground'>Employer of Record: a service that allows you to legally hire employees in other countries without setting up a local entity.</p></InfoDropdown>-plus-recruiter. They handle hiring and payroll, but they do not provide secure devices, <InfoDropdown title={<span class='border-b border-dashed'>MDM</span>}><p class='text-sm text-muted-foreground'>Mobile Device Management: software that secures, monitors, and manages devices like laptops.</p></InfoDropdown>, or insurance, leaving critical security and governance gaps.",
