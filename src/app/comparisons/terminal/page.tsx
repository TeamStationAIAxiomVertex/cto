...
const comparisonData = [
    ...
    { feature: '2.6M+ Profile Neural Search (Nebula™)', teamstation: true },
    { feature: 'Bundled Hardware, Offices, and Cyber Insurance', teamstation: true },
    { feature: 'Focus on EOR + Recruiting Service', competitor: true },
];
