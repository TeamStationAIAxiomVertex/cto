...
const comparisonPoints = {
    ...
    "Operations": {
        ...
        teamstation: "Our integrated platform is a complete operational wrapper. We handle <InfoDropdown title={<span class='border-b border-dashed'>EOR</span>}><p class='text-sm text-muted-foreground'>Employer of Record: a service that allows you to legally hire employees in other countries without setting up a local entity.</p></InfoDropdown>, <InfoDropdown title={<span class='border-b border-dashed'>MDM</span>}><p class='text-sm text-muted-foreground'>Mobile Device Management: software that secures, monitors, and manages devices like laptops.</p></InfoDropdown>-secured devices, and insurance, so you can focus on your product.",
