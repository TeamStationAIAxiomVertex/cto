...
const comparisonPoints = {
    "Operations": {
        ...
        traditional: "TECLA is a talent marketplace. They connect you with talent, but the significant burden of compliance, payroll (<Tooltip text='Employer of Record: a service that allows you to legally hire employees in other countries without setting up a local entity.'>EOR</Tooltip>), and IT security falls squarely on you.",
        teamstation: "We are your global employer platform. We absorb all operational complexity—EOR, secure devices (<Tooltip text='Mobile Device Management: software that secures, monitors, and manages devices like laptops.'>MDM</Tooltip>), and insurance—into one accountable SLA.",
