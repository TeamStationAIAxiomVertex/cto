...
const comparisonPoints = {
    ...
    "Operations": {
        ...
        traditional: "Their model still leaves the client to manage critical components like compliant hiring (<Tooltip text='Employer of Record: a service that allows you to legally hire employees in other countries without setting up a local entity.'>EOR</Tooltip>), secure device management (<Tooltip text='Mobile Device Management: software that secures, monitors, and manages devices like laptops.'>MDM</Tooltip>), and insurance.",
