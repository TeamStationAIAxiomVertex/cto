...
export default function ParallelStaffComparisonPage() {
    ...
    const breadcrumbSchema = {
        ...
        { "@type": "ListItem", "position": 3, "name": "ParallelStaff", "item": `${siteUrl}/comparisons/parallelstaff` }
        ]
    };
  return (
    <>
      ...
      <main className="manual-page container py-10">
        ...
        />
        <FurtherReading comparison="parallelstaff" />
      </main>
    </>
  );
}
