    ...
    <main className="container max-w-4xl py-12">
      ...
      <header className="my-8">
        ...
        <p className="mt-4 text-lg text-muted-foreground">
          This is a real (anonymized) evaluation report generated by our <Link href="/research/axiom-cortex-scientific-report" className="text-primary hover:underline">Axiom Cortex™</Link> engine. It's how we move beyond resumes to provide auditable proof of a candidate's ability to solve your problems.
        </p>
      </header>
      ...
      <div className="my-12 rounded-lg border bg-card p-6">
        ...
        <div className='my-12'>
            ...
            <p className='text-muted-foreground mt-2'>
                This is the raw data—the proof behind our analysis. We compare candidate responses against ideal answer blueprints to provide an objective score.
            </p>
