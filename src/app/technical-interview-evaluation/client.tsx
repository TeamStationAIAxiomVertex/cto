    ...
    <main className="container max-w-5xl py-12">
      ...
      <header className="my-8">
        ...
        <p className="mt-4 text-lg text-muted-foreground">
          This is a real (anonymized) evaluation report generated by our <Tooltip text="Our proprietary Cognitive AI engine for talent evaluation."><Link href="/research/axiom-cortex-scientific-report" className="text-primary hover:underline">Axiom Cortex™</Link></Tooltip> engine. It's how we move beyond resumes to provide auditable proof of a candidate's ability to solve your problems.
        </p>
      </header>
      ...
      <div className="my-16 space-y-8">
        ...
        <div className="rounded-lg border bg-card p-6 shadow-lg">
            ...
            <div className="mt-8 prose dark:prose-invert max-w-none text-sm">
                 <h4 className="flex items-center gap-2 text-base"><Tooltip text="How is this score calculated?"><HelpCircle className="h-5 w-5 text-primary" /></Tooltip>How is this score calculated?</h4>
