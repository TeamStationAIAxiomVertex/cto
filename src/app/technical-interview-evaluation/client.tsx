    ...
    <main className="container max-w-4xl py-12">
      ...
      <header className="my-8">
        ...
        <p className="mt-4 text-lg text-muted-foreground">
          This is a real (anonymized) evaluation report generated by our <Link href="/research/axiom-cortex-scientific-report" className="text-primary hover:underline">Axiom Cortex™ Cognitive AI</Link> engine. It's how we move beyond resumes to provide auditable proof of a candidate's ability to solve your problems.
        </p>
      </header>
