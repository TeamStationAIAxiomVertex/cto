    ...
    <main className="container max-w-4xl py-12">
      ...
      <header className="my-8">
        ...
        <p className="mt-4 text-lg text-muted-foreground">
          This page demonstrates a real (anonymized) evaluation report generated by our <Link href="/research/axiom-cortex-scientific-report" className="text-primary hover:underline">Axiom Cortex™</Link> engine. For a full breakdown of the science and methodology, please see our complete <Link href="/process" className="text-primary hover:underline">Evidence-Based Evaluation guide</Link>.
        </p>
      </header>
      ...
      <div className="my-12 rounded-lg border bg-card p-6">
        ...
        <div className='my-12'>
            <h2 className="text-3xl font-bold">Risk Factors & Mitigation</h2>
             <p className='text-muted-foreground mt-2'>
                Every hire has risks. Our process identifies them and provides a concrete, actionable plan to mitigate them from Day 1.
            </p>
        ...
        <div className='my-12'>
            ...
            <p className='text-muted-foreground mt-2'>
                Analysis of the candidate's responses to key technical and behavioral questions, mapped to ideal answer blueprints.
            </p>
