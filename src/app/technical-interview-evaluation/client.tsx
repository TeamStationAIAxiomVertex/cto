...
import { Accordion, InfoDropdown } from '@/components/Accordion';
      ...
      <div className="my-16 space-y-8">
        ...
        <div className="rounded-lg border bg-card p-6 shadow-lg">
            ...
            <div className="mt-8 prose dark:prose-invert max-w-none text-sm">
                 <InfoDropdown title={<h4 className="flex items-center gap-2 text-base font-bold">How is this score calculated?</h4>}>
                    <p className="text-sm text-muted-foreground">The score is a data-driven output from the Axiom Cortex™ AI. The engine analyzes the full interview transcript, maps the candidate's statements to our proprietary BARS rubric, and applies calibration layers to mitigate bias. The final score is a weighted synthesis of performance across multiple questions, grounded in direct evidence.</p>
                </InfoDropdown>
            </div>
            ...
            <div className="mt-8 pt-6 border-t border-border">
                 <div className="rounded-lg border bg-background p-4">
                    ...
                    <div className="flex items-center gap-3 mt-3">
                        ...
                        <h3 className="text-lg font-semibold text-foreground"><InfoDropdown title={<span className="border-b border-dashed">MCI Analysis</span>}><p className="text-sm text-muted-foreground">Metacognitive Conviction Index: Assesses how well a candidate's confidence is calibrated with their actual knowledge.</p></InfoDropdown></h3>
                    </div>
            ...
            <div className="mt-8">
                <Accordion>
                    {evidenceLocker.map(item => (
                        <InfoDropdown title={item.title} key={item.title}>
                            {item.content}
                        </InfoDropdown>
                    ))}
                </Accordion>
