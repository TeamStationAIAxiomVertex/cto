    ...
    <main className="container max-w-4xl py-12">
      ...
      <header className="my-8">
        ...
        <p className="mt-4 text-lg text-muted-foreground">
          This page demonstrates a real (anonymized) evaluation report generated by our Axiom Cortex™ engine. For a full breakdown of the science and methodology, please see our complete <Link href="/research/axiom-cortex-scientific-report" className="text-primary hover:underline">AxiomCortex™ Scientific R&D Report</Link>.
        </p>
      </header>
