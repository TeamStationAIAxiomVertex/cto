...
export const metadata: Metadata = {
  title: { absolute: 'Hire Next.js Developers in Mexico | TeamStation AI' },
  description: 'Hire vetted Next.js developers in Mexico with daylight overlap. Senior React engineers under a single, compliant SLA.',
  alternates: {
