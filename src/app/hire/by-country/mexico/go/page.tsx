...
export const metadata: Metadata = {
  title: { absolute: 'Hire Go Developers in Mexico | TeamStation AI' },
  description: 'Hire vetted Go developers in Mexico with daylight overlap. Senior Golang engineers systems under a single, compliant SLA.',
  alternates: {
