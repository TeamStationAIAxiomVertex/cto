  ...
  return (
    <main className="container py-12">
      ...
      <header className="text-center my-12">
        <h1 className="text-5xl font-extrabold tracking-tight bg-gradient-to-r from-primary to-blue-400 bg-clip-text text-transparent">World-Class Talent, in Your Time Zone</h1>
        <p className="mt-4 max-w-3xl mx-auto text-lg text-muted-foreground">
       Stop losing a full day of productivity to time-zone latency. Our nearshore model provides access to the top engineering hubs in Latin America, enabling the real-time collaboration that agile development demands.
      </p>
      </header>
