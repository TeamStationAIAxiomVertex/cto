...
export const metadata: Metadata = {
  title: { absolute: 'Hire Next.js Developers in Argentina | TeamStation AI' },
  description: 'Hire vetted Next.js developers in Argentina with daylight overlap. Senior React engineers under a single, compliant SLA.',
  alternates: {
