...
export const metadata: Metadata = {
  title: { absolute: 'Hire Node.js Developers in Argentina | TeamStation AI' },
  description: 'Hire vetted Node.js developers in Argentina with daylight overlap. Senior NestJS & Fastify engineers under one compliant SLA.',
  alternates: {
