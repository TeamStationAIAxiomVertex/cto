...
export const metadata: Metadata = {
  title: { absolute: 'Hire Python Developers in Argentina | TeamStation AI' },
  description: 'Hire vetted Python developers in Argentina with US daylight overlap. Senior Django & FastAPI engineers under one compliant SLA.',
  alternates: {
