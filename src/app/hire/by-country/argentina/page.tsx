...
export async function generateMetadata(): Promise<Metadata> {
    if (!argentinaData) {
        return {
            ...
            description: "Information about hiring nearshore developers in Argentina.",
        };
    }
    return {
        ...
        <section className="my-24">
         ...
         <section className="text-center rounded-lg bg-primary/10 p-8 shadow-lg">
            ...
            <p className="mt-2 mx-auto max-w-xl text-muted-foreground">
              Let's build a TCO model for your Argentina team and map your roles to our <a href="/playbook/bias-free-technical-hiring-axiom-cortex" className="text-primary hover:underline">Axiom Cortex™</a> evaluation process.
            </p>
