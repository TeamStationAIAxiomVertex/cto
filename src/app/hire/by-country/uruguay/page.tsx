...
export async function generateMetadata(): Promise<Metadata> {
    if (!uruguayData) {
        return {
            title: "Hire Developers in Uruguay",
            description: "Information about hiring nearshore developers in Uruguay.",
        };
    }
    return {
        ...
        alternates: {
            ...
            languages: uruguayData.pageSEO.hreflang,
        },
    };
}
            ...
            <div className="my-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 my-12 justify-center">
                {popularTech.map((tech) => (
                  <Link href={`/hire/by-country/uruguay/${tech.slug}`} key={tech.slug} className="group flex flex-col glass-panel gradient-ring rounded-2xl p-6 md:p-8 transition-all hover:-translate-y-1 hover:shadow-2xl hover:shadow-primary/10">
        ...
        <section className="my-24">
         ...
         <section className="text-center rounded-lg bg-primary/10 p-8 shadow-lg">
            ...
            <p className="mt-2 mx-auto max-w-xl text-muted-foreground">
              Let's build a TCO model for your Uruguay team and map your roles to our <a href="/playbook/bias-free-technical-hiring-axiom-cortex" className="text-primary hover:underline">Axiom Cortex™</a> evaluation process.
            </p>
