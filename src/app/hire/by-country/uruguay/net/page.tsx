...
export const metadata: Metadata = {
  title: 'Hire .NET Developers in Uruguay | Nearshore C# & ASP.NET Core',
  description: 'Hire vetted .NET developers from Uruguay. Our senior C# & ASP.NET Core engineers from this stable, high-skill market ship secure, scalable code under a single, compliant SLA.',
  alternates: {
    canonical: 'https://cto.teamstation.dev/hire/by-country/uruguay/net',
  },
};
...
const pspCards = [
    {
      ...
      icon: GitCompare,
      body: {
        "problem": "You need senior .NET talent for mission-critical systems, but can't risk the project disruptions caused by regional instability or time-zone lag.",
        ...
        "prescription": "Leverage Uruguay's highly stable, business-friendly environment and its export-oriented talent pool. We staff your team with senior .NET engineers from Montevideo, ensuring 5-7 hours of consistent daily overlap, backed by LATAM's most reliable digital infrastructure.",
        ...
        "recap": "When you <strong>hire .NET developers in Uruguay</strong>, you are investing in a low-risk, high-skill environment built for enterprise-grade, daylight collaboration."
      }
    },
    {
      "title": "Vetting for Deep .NET and Cloud-Native Mastery",
      "icon": UserCheck,
      "body": {
        "problem": "You need a .NET engineer who thinks in terms of modern ASP.NET Core and cloud-native patterns, not just someone with legacy .NET Framework experience.",
        ...
        "prescription": "Tap into Uruguay's highly-educated talent. Our <a href='/playbook/bias-free-technical-hiring-axiom-cortex' class='text-primary hover:underline'>Axiom Cortex™</a> engine vets for a deep understanding of modern .NET architecture, dependency injection, and EF Core performance tuning.",
        ...
        "recap": "Stop gambling on keywords. Build your team of <strong>nearshore .NET developers in Uruguay</strong> with a partner that provides data-driven proof of cognitive ability and modern framework mastery."
      }
    },
    {
      ...
      "body": {
        ...
        "recap": "Use an integrated platform that delivers a secure and compliant <strong>Uruguay .NET development team</strong> from day one."
      }
    },
    {
      ...
      "body": {
        ...
        "recap": "Choose a partner that offers a clear financial model for scaling your <strong>.NET team in Uruguay</strong>."
      }
    }
  ];

export default function HireDotNetUruguayPage() {
  ...
  const faq = [
    ...
    },
    {
      ...
      "a": `We use our Nebula™ Talent Graph of over 2.6 million LATAM profiles, filtering for candidates with proven experience in building and scaling production .NET systems from Montevideo's high-skill talent pool.`
    },
    {
  ...
  return (
    <main className="container max-w-5xl py-12">
      ...
      <header className="my-8 text-center">
          <h1 className="text-4xl font-extrabold tracking-tight md:text-5xl bg-gradient-to-r from-primary to-blue-400 bg-clip-text text-transparent">Hire .NET Developers in Uruguay</h1>
          <p className="mt-4 text-lg text-muted-foreground max-w-3xl mx-auto" dangerouslySetInnerHTML={{ __html: `Build your enterprise applications with elite <strong>.NET developers from Uruguay</strong>. Our platform provides senior, pre-vetted C# and ASP.NET Core experts from a stable, high-skill market who ship secure and scalable code under a single, compliant SLA.` }}></p>
      </header>
       ...
       <CTOFieldManualBlock
        ...
        <section className="text-center rounded-lg bg-primary/10 p-8 shadow-lg">
          ...
          <p className="mt-2 mx-auto max-w-xl text-muted-foreground">
            Let's build a TCO model for your Uruguay-based .NET team and map your roles to our <a href="/playbook/bias-free-technical-hiring-axiom-cortex" className="text-primary hover:underline">Axiom Cortex™</a> evaluation process.
          </p>
