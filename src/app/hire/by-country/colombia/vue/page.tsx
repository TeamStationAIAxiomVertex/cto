...
export const metadata: Metadata = {
  title: { absolute: 'Hire Vue.js Developers in Colombia | TeamStation AI' },
  description: 'Hire vetted Vue.js developers in Colombia with daylight overlap. Senior engineers under a single, compliant SLA.',
  alternates: {
