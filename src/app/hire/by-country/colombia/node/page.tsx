...
export const metadata: Metadata = {
  title: { absolute: 'Hire Node.js Developers in Colombia | TeamStation AI' },
  description: 'Hire vetted Node.js developers in Colombia with daylight overlap. Senior NestJS & Fastify engineers under one compliant SLA.',
  alternates: {
