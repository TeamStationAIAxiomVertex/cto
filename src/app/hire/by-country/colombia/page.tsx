...
export const metadata: Metadata = {
  title: 'Colombia Software Outsourcing | Hire Vetted Colombian Developers',
  description: 'Leverage Colombia software outsourcing to build your team. Hire elite, pre-vetted Colombian developers with TeamStation AI. Same time-zone, full compliance.',
};

const country = { 
  name: 'Colombia',
  highlights: [
      'A rapidly growing tech ecosystem, especially in Medellín and Bogotá, with strong government support for software outsourcing.',
      'High concentration of bilingual talent with excellent communication skills, ideal for nearshore teams.',
      'A resilient and adaptable workforce known for its strong problem-solving abilities and cultural alignment with the U.S.'
  ]
};
  ...
  return (
    <main className="container py-12">
      ...
      <header className="text-center my-12">
        <h1 className="text-5xl font-extrabold tracking-tight bg-gradient-to-r from-primary to-blue-400 bg-clip-text text-transparent">Elite Colombia Software Outsourcing</h1>
      ...
      <div className="my-16 rounded-lg border bg-card p-8">
        <h2 className="text-3xl font-bold text-center">Why Colombia for Top Engineering Talent?</h2>
        <div className="grid md:grid-cols-3 gap-8 mt-8 text-muted-foreground">
            <div className='flex items-start gap-4'>
                ...
                <div>
                    <h3 className='font-semibold text-foreground'>Growing Tech Ecosystem</h3>
