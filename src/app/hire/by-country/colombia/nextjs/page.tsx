...
export const metadata: Metadata = {
  title: { absolute: 'Hire Next.js Developers in Colombia | TeamStation AI' },
  description: 'Hire vetted Next.js developers in Colombia with daylight overlap. Senior React engineers under a single, compliant SLA.',
  alternates: {
