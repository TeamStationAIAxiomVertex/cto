...
export const metadata: Metadata = {
  title: 'Hire Vue.js Developers in Chile | Nearshore Experts',
  description: 'Hire vetted Vue.js developers in Chile with daylight overlap. Our senior engineers ship approachable, performant UIs under a single, compliant SLA.',
  alternates: {
