...
import chileData from "../../../../data/countries/chile.json";
...
export async function generateMetadata(): Promise<Metadata> {
    if (!chileData) {
        return {
            title: "Hire Developers in Chile",
            description: "Information about hiring nearshore developers in Chile.",
        };
    }
    return {
        ...
        alternates: {
            ...
            languages: chileData.pageSEO.hreflang,
        },
    };
}
      ...
      <main className="container max-w-5xl py-12">
        ...
        <section className="my-24 space-y-16">
            ...
            <div className="my-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 my-12 justify-center">
                {popularTech.map((tech) => (
                  <Link href={`/hire/by-country/chile/${tech.slug}`} key={tech.slug} className="group flex flex-col glass-panel gradient-ring rounded-2xl p-6 md:p-8 transition-all hover:-translate-y-1 hover:shadow-2xl hover:shadow-primary/10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 my-12">
                ...
                <Link href={`/hire/by-role/${details.slug}`} key={details.slug} className="group flex flex-col glass-panel gradient-ring rounded-2xl p-6 md:p-8 transition-all hover:-translate-y-1 hover:shadow-2xl hover:shadow-primary/10">
                    <div className='flex justify-between items-start'>
        ...
        <section className="my-24">
         ...
         <section className="text-center rounded-lg bg-primary/10 p-8 shadow-lg">
            ...
            <p className="mt-2 mx-auto max-w-xl text-muted-foreground">
              Let's build a TCO model for your Chile team and map your roles to our <a href="/playbook/bias-free-technical-hiring-axiom-cortex" className="text-primary hover:underline">Axiom Cortex™</a> evaluation process.
            </p>
