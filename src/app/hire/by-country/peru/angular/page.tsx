...
export const metadata: Metadata = {
  title: { absolute: 'Hire Angular Developers in Peru | TeamStation AI' },
  description: 'Hire vetted Angular developers in Peru with daylight overlap. Senior engineers under a single, compliant SLA.',
  alternates: {
