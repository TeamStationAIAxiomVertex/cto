...
export const metadata: Metadata = {
  title: 'Hire .NET Developers in Peru | Nearshore C# & ASP.NET Core',
  description: 'Hire vetted .NET developers in Peru with daylight overlap. Our senior C# & ASP.NET Core engineers ship secure, scalable code under a single, compliant SLA.',
  alternates: {
    canonical: 'https://cto.teamstation.dev/hire/by-country/peru/net',
  },
};
...
const pspCards = [
    {
      ...
      body: {
        ...
        "prescription": "Replace the overnight queue with a daylight-native cadence. We staff pods of senior .NET engineers in Peru with a guaranteed 5 7 hours of daily overlap, ensuring a continuous, real-time workflow.",
        ...
        "recap": "Stop letting time zones dictate your release schedule. When you <strong>hire .NET developers in Peru</strong>, you buy back your day with a team that operates on your clock."
      }
    },
    {
      ...
      "body": {
        ...
        "recap": "Stop gambling on keywords. Build your team of <strong>nearshore .NET developers in Peru</strong> with a partner that provides data-driven proof of cognitive ability."
      }
    },
    {
      ...
      "icon": ShieldCheck,
      "body": {
        "problem": "You want to access Peru's .NET talent, but the operational overhead is daunting. How do you handle local labor laws, secure remote work, and manage devices?",
        ...
        "recap": "Don't let operational complexity stop you. Use an integrated platform that delivers a secure and audit-ready <strong>Peru .NET development team</strong> from the start."
      }
    },
    {
      ...
      "body": {
        ...
        "recap": "Choose a partner that provides a clear financial model and is accountable for a fast ramp-up. It's the smarter way to scale your <strong>.NET team in Peru</strong>."
      }
    }
  ];

export default function HireDotNetPeruPage() {
  const country = "Peru";
  ...
  const faq = [
    ...
    },
    {
      ...
      "a": `We use our Nebula™ Talent Graph of over 2.6 million LATAM profiles, filtering for candidates with proven experience in building and scaling production .NET systems, especially in hubs like Lima.`
    },
    {
  ...
  return (
    <main className="container max-w-5xl py-12">
      ...
      <header className="my-8 text-center">
          <h1 className="text-4xl font-extrabold tracking-tight md:text-5xl bg-gradient-to-r from-primary to-blue-400 bg-clip-text text-transparent">Hire .NET Developers in Peru</h1>
          <p className="mt-4 text-lg text-muted-foreground max-w-3xl mx-auto" dangerouslySetInnerHTML={{ __html: `Stop letting a 12-hour time lag kill your development velocity. Hire senior <strong>.NET developers in Peru</strong> and integrate them directly into your US time-zone workflow. Our platform provides elite, pre-vetted C# and ASP.NET Core experts who ship secure, scalable code under a single, compliant SLA.` }}></p>
      </header>
      ...
      <section className="my-24">
       ...
       <section className="text-center rounded-lg bg-primary/10 p-8 shadow-lg">
          ...
          <p className="mt-2 mx-auto max-w-xl text-muted-foreground">
            Let's build a TCO model for your Peru-based .NET team and map your roles to our <a href="/playbook/bias-free-technical-hiring-axiom-cortex" className="text-primary hover:underline">Axiom Cortex™</a> evaluation process.
          </p>
