...
export const metadata: Metadata = {
  title: { absolute: 'Hire Next.js Developers in Ecuador | TeamStation AI' },
  description: 'Hire vetted Next.js developers in Ecuador with daylight overlap. Senior React engineers under a single, compliant SLA.',
  alternates: {
