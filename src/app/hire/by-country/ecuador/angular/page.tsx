...
export const metadata: Metadata = {
  title: { absolute: 'Hire Angular Developers in Ecuador | TeamStation AI' },
  description: 'Hire vetted Angular developers in Ecuador with daylight overlap. Senior engineers under a single, compliant SLA.',
  alternates: {
