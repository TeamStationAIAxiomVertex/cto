...
export const metadata: Metadata = {
  title: { absolute: 'Hire Next.js Developers in Brazil | TeamStation AI' },
  description: 'Hire vetted Next.js developers in Brazil with daylight overlap. Senior React engineers under a single, compliant SLA.',
  alternates: {
