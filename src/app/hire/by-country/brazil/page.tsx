             ...
             <div className="my-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 my-12 justify-center">
                {popularTech.map((tech) => (
                  <Link href={`/hire/by-country/brazil/${tech.slug}`} key={tech.slug} className="group flex flex-col glass-panel rounded-2xl p-6 md:p-8 transition-all hover:-translate-y-1 hover:shadow-2xl hover:shadow-primary/10">
