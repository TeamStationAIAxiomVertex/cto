...
export const metadata: Metadata = {
  title: { absolute: 'Hire React Developers in Brazil | TeamStation AI' },
  description: 'Hire vetted React developers in Brazil with daylight overlap. Senior TypeScript & Next.js engineers under one compliant SLA.',
  alternates: {
