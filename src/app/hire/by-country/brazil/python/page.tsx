...
export const metadata: Metadata = {
  ...
  description: 'Hire vetted Python developers in Brazil with daylight overlap. Our senior Django & FastAPI engineers ship secure, scalable code under a single, compliant SLA.',
  alternates: {
