...
export const metadata: Metadata = {
  ...
  description: 'Hire vetted Node.js developers in Brazil with daylight overlap. Our senior NestJS & Fastify engineers ship secure, scalable code under a single, compliant SLA.',
  alternates: {
