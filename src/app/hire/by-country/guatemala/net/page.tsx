...
export const metadata: Metadata = {
  title: { absolute: 'Hire .NET Developers in Guatemala | TeamStation AI' },
...
const schema = {
  breadcrumbs: {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 4, "name": ".NET", "item": `${siteUrl}/hire/by-country/guatemala/net` }
    ]
  },
  service: {
    "@context": "https://schema.org",
    ...
    "description": `Hire elite .NET developers in Guatemala. We provide senior, pre-vetted engineers specializing in C# and ASP.NET Core with full US time-zone overlap.`,
    "name": `Hire .NET Developers in Guatemala`,
