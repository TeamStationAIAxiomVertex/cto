...
export const metadata: Metadata = {
  title: { absolute: 'Hire Next.js Developers in Guatemala | TeamStation AI' },
  description: 'Hire vetted Next.js developers in Guatemala with perfect CST overlap. Senior React engineers under a single, compliant SLA.',
  alternates: {
