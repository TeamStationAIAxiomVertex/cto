...
const pspCards = [
    {
      ...
      body: {
        ...
        "prescription": "Eliminate the time-zone tax completely. We assemble elite pods of Next.js engineers in Guatemala with a guaranteed full workday of collaborative overlap, ensuring real-time architectural discussions and PR reviews.",
