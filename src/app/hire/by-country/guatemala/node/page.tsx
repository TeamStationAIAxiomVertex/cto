...
export const metadata: Metadata = {
  ...
  description: 'Hire vetted Node.js developers in Guatemala with perfect CST overlap. Our senior NestJS & Fastify engineers ship secure, scalable code under a single, compliant SLA.',
  alternates: {
...
const pspCards = [
    {
      ...
      body: {
        ...
        "prescription": "Eliminate the time-zone tax completely. We staff your team with senior Node.js engineers from Guatemala with a guaranteed full overlap with US Central Time Zone teams for a real-time, synchronous workflow.",
