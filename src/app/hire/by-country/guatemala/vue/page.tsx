...
const pspCards = [
    {
      ...
      body: {
        ...
        "prescription": "Eliminate the time-zone tax completely. We assemble elite pods of Vue.js engineers in Guatemala with a guaranteed full workday of collaborative overlap, ensuring real-time architectural discussions and PR reviews.",
    ...
    },
    {
      ...
      "body": {
        ...
        "recap": "Don't gamble on keywords. Build your team of <strong>nearshore Vue.js developers in Guatemala</strong> with a partner that provides auditable proof of their cognitive ability and framework mastery."
      }
    },
    {
