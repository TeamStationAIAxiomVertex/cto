...
export const metadata: Metadata = {
  ...
  description: 'Hire vetted Java developers in Guatemala with perfect CST overlap. Our senior Spring Boot engineers ship secure, scalable code under a single, compliant SLA.',
  alternates: {
