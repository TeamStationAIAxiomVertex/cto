...
export const metadata: Metadata = {
  title: 'Hire Python Developers in Guatemala | Nearshore Experts',
  description: 'Hire vetted Python developers in Guatemala with perfect CST overlap. Our senior Django & FastAPI engineers ship secure, scalable code under a single, compliant SLA.',
  alternates: {
...
const pspCards = [
    ...
    },
    {
      ...
      "icon": UserCheck,
      "body": {
        "problem": "You need a Python engineer who can architect a scalable FastAPI application, but resumes are unreliable and traditional interviews are biased.",
    ...
    },
    {
      ...
      "body": {
        ...
        "stakes": "One unmanaged personal laptop is a compliance disaster. Misunderstanding local labor laws creates significant legal and financial exposure.",
    ...
    },
    {
      ...
      "body": {
        ...
        "stakes": "A slow ramp-up means delayed features and a lower ROI. Without a clear TCO model, you can't make a strategic business case.",
        "prescription": "We engineer for a fast ramp, targeting a first PR within 10 business days. Our all-inclusive pricing provides a transparent, predictable TCO that leverages Guatemala's cost-effectiveness without sacrificing quality.",
  ...
  const faq = [
    {
      ...
      "a": `We focus on modern Python (3.9+). Our vetting emphasizes deep knowledge of a primary framework (Django or FastAPI), ORM performance tuning, and a strong grasp of Python's concurrency models.`
    },
    {
