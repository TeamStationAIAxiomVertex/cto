...
export const metadata: Metadata = {
  title: { absolute: 'Hire React Developers in Guatemala | TeamStation AI' },
  description: 'Hire vetted React developers in Guatemala with perfect CST overlap. Senior TypeScript engineers under one compliant SLA.',
  alternates: {
