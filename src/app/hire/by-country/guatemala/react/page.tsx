...
const pspCards = [
    {
      ...
      body: {
        ...
        "prescription": "Eliminate the time-zone tax completely. We assemble elite pods of React engineers in Guatemala with a guaranteed full workday of collaborative overlap, ensuring real-time architectural discussions and PR reviews.",
  ...
  const faq = [
    {
      ...
      "a": `We focus on modern React (18+) with Hooks, advanced state management (React Query, Zustand), component performance optimization, and strong TypeScript practices.`
    },
    {
