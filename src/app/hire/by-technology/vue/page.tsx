...
export const metadata: Metadata = {
  title: `Hire Nearshore Vue.js Developers`,
  description: `Hire elite, pre-vetted LATAM engineers with expertise in Vue.js. Our scientific evaluation de-risks hiring for critical roles.`,
  keywords: `hire nearshore Vue.js developers, latam Vue.js engineers, Vue.js staff augmentation`,
};

export default function TechPage() {
  const tech = allTech["vue"];
  const siteUrl = "https://cto.teamstation.dev";

  // Ensure we don't access properties on an undefined tech during prerender
  if (!tech) {
    return (
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 3,
        name: tech.name,
        item: `${siteUrl}/hire/by-technology/vue`,
      },
    ],
  };
      ...
      <main className="container max-w-5xl py-12">
        ...
        <div className="my-16 rounded-lg border bg-card p-8">
          ...
          <p className="mt-2 max-w-3xl mx-auto text-center text-muted-foreground">
            ...
            focuses on practical application and deep system understanding, not
            just trivia. We assess candidates on:
          </p>
