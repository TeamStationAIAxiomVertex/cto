...
export const metadata: Metadata = {
  title: `Hire Nearshore Java Developers`,
  description: `Hire elite, pre-vetted LATAM engineers with expertise in Java. Our scientific evaluation de-risks hiring for critical roles.`,
  keywords: `hire nearshore Java developers, latam Java engineers, Java staff augmentation`,
};

export default function TechPage() {
  const tech = allTech["java"];
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 3,
        name: tech.name,
        item: `${siteUrl}/hire/by-technology/java`,
      },
    ],
  };
