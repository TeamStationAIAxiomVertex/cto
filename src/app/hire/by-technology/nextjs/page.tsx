...
export const metadata: Metadata = {
  ...
  keywords: `hire nearshore Next.js developers, latam Next.js engineers, Next.js staff augmentation`,
};

export default function TechPage() {
  const tech = allTech["nextjs"];
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 3,
        name: tech.name,
        item: `${siteUrl}/hire/by-technology/nextjs`,
      },
    ],
  };
