...
export const metadata: Metadata = {
  ...
  keywords: `hire nearshore Angular developers, latam Angular engineers, Angular staff augmentation`,
};

export default function TechPage() {
  const tech = allTech["angular"];
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 3,
        name: tech.name,
        item: `${siteUrl}/hire/by-technology/angular`,
      },
    ],
  };
