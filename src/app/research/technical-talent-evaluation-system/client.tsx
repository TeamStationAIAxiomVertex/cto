    ...
    <main className="container max-w-5xl py-12">
      ...
      <header className="my-8">
        ...
        <p className="mt-4 text-lg text-muted-foreground">
          This is a real (anonymized) evaluation report generated by our <WithTooltip content="Our proprietary Cognitive AI engine for talent evaluation."><Link href="/research/axiom-cortex-scientific-report" className="text-primary hover:underline">Axiom Cortex™</Link></WithTooltip> engine. It's how we move beyond resumes to provide auditable proof of a candidate's ability to solve your problems.
        </p>
      </header>
            ...
            <div className="mt-8 pt-6 border-t border-border">
                 <div className="rounded-lg border bg-background p-4">
                    ...
                    <div className="mt-4 text-sm text-muted-foreground">
                        ...
                        <span> is exceptionally high due to his repeated, voluntary admissions of his knowledge boundaries. This demonstrates a precise and accurate understanding of what he knows and what he doesn't.</span>
                    </div>
                    <div className="mt-4 border-t border-border pt-4">
                        <h4 className="font-semibold text-foreground">Proof:</h4>
