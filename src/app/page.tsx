  ...
  return (
    <div className="container mx-auto max-w-7xl px-6 py-12">
      <section className="py-12 text-center">
        <h1 className="text-4xl md:text-5xl font-bold leading-tight !bg-clip-text !text-transparent bg-gradient-to-r from-accent-custom to-accent-d-custom">The CTO Playbook</h1>
