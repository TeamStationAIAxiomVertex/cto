...
const buySolutions = [
    { 
        ...
        proof: "Time-to-Offer ≈ 9 days (vs. 45-day industry average)",
    ...
    { 
        ...
        proof: "Zero legal or HR overhead for your team.",
    ...
    { 
        ...
        proof: "SOC 2 & ISO Aligned posture included.",
        href: "/trust",
  ...
  return (
    <main className="container max-w-5xl py-12">
        ...
        <div className="prose dark:prose-invert max-w-none text-center">
            <h2 className="mt-16">The "Build" Model: A High-Risk, High-Cost Gamble</h2>
        ...
        <div className="my-8 overflow-x-auto rounded-lg border bg-card">
                ...
                <tbody className="divide-y divide-border">
                    {buildCosts.map((item) => (
                        <tr key={item.area}>
                            ...
                            <td className="p-4 text-muted-foreground">{item.tax.replace('MDM', '')}
         ...
         <div className="prose dark:prose-invert max-w-none text-center">
            <p><em>This is <strong>in addition</strong> to the engineer's salary. The "cheaper" build model is often twice as expensive in the first year.</em></p>
            
            <h2 className="mt-16">The "Buy" Model: The Integrated Platform Solution</h2>
         ...
         <div className="my-16">
            <h2 className="text-center text-3xl font-bold">How We Eliminate the Hidden Taxes</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
                 {buySolutions.map((item) => (
                    <div key={item.pain} className="rounded-lg border bg-card p-6 flex flex-col">
                        ...
                        <h3 className="text-lg font-semibold text-foreground mt-3">{item.solutionTitle}</h3>
                        <p className="mt-2 text-sm text-muted-foreground flex-grow">{item.solution.replace('Axiom Cortex™', '').replace('EOR', '').replace('MDM', '')}
