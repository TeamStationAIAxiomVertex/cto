              ...
              <tr className="border-b border-border/50">
               ...
               <tr className="border-b border-border/50">
                ...
                <td className="px-4 py-4">
                   ...
                   <p className="text-xs text-foreground m-0">A human expert conducts a structured, bias-aware interview. Our <Tooltip text="Our proprietary Cognitive AI engine for talent evaluation."><Link href="/research/axiom-cortex-scientific-report" className="text-primary hover:underline">Axiom Cortex™</Link></Tooltip> AI synthesizes the conversation, providing a "Cognitive Fingerprint" and a full <Tooltip text="Every evaluation generates a complete 'Evidence Locker' with transcripts, scores, and an explainable hiring signal."><Link href="/technical-interview-evaluation" className="text-primary hover:underline">Evidence Locker</Link></Tooltip> to prove a candidate's abilities.</p>
                </td>
              </tr>
                <tr className="border-b border-border/50">
