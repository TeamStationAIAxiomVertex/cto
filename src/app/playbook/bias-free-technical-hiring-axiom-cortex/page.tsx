...
export const metadata: Metadata = {
  ...
  keywords: 'bias-free hiring, cognitive ai hiring, axiom cortex, technical recruiting, cto playbook',
  alternates: {
              ...
              <tbody>
                ...
                <tr className="border-b border-border/50">
                  ...
                  <td className="px-4 py-4">
                    ...
                    <p className="text-xs text-foreground m-0">A human expert conducts a structured, bias-aware interview. Our <WithTooltip content="Our proprietary Cognitive AI engine for talent evaluation."><span className="border-b border-dashed">Axiom Cortex™</span></WithTooltip> AI synthesizes the conversation, providing a "Cognitive Fingerprint" and a full <WithTooltip content="Every evaluation generates a complete 'Evidence Locker' with transcripts, scores, and an explainable hiring signal."><span className="border-b border-dashed">Evidence Locker</span></WithTooltip> to prove a candidate's abilities.</p>
                  </td>
                </tr>
                  <tr className="border-b border-border/50">
