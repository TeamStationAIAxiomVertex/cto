...
const faqSchema = {
 ...
 "mainEntity": [
   {
     "@type": "Question",
     "name": "Why is LATAM cost-effective for U.S. CTOs?",
     "acceptedAnswer": { "@type": "Answer", "text": "LATAM offers lower TCO due to favorable labor economics, reduced time-to-offer, and daylight overlap that cuts rework and hidden costs." }
   },
   {
     "@type": "Question",
     "name": "What financial advantage does LATAM nearshore provide?",
     "acceptedAnswer": { "@type": "Answer", "text": "Compared to U.S. hiring, LATAM nearshore can deliver 40–60% savings while keeping compliance and performance KPIs intact." }
   }
 ]
};
...
const financialLevers = [
    ...
    },
    {
        ...
        description: 'Every day a critical role sits empty, you pay a "Vacancy Tax" in lost productivity and delayed revenue. A 60-day hiring cycle for a feature worth $1M in ARR costs you over $160,000 in lost opportunity. High-concentration LATAM talent pools mean we hire faster, pulling your future revenue forward.',
