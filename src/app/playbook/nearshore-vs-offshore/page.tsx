    ...
    <main className="container max-w-5xl py-12">
      ...
      <section className="my-24 rounded-lg border bg-card p-8">
        ...
        <div className="prose dark:prose-invert max-w-none mx-auto mt-8">
            <h4>The Human Latency Tax</h4>
            <p>This is the most significant and most often ignored cost. Assume a team of 6 engineers. A 12-hour time difference means that for every simple question, an entire workday is lost. If each engineer loses just 2 hours per day to waiting—a conservative estimate—that's 12 hours of wasted, fully-loaded engineering time every single day. At a loaded cost of $50/hour, that's $600 per day, or **$132,000 per year**, evaporated into thin air. That's the cost of a senior US engineer, spent on waiting.</p>
            
            <h4>The Management Overhead Tax</h4>
            <p>Your engineering managers and product managers are expensive, high-leverage resources. An offshore model forces them into the role of vendor coordinators and late-night wranglers. If an EM spends 25% of their time managing offshore communications and rework, that's a quarter of their $200k+ salary—**$50,000 per year**—dedicated to mitigating a problem that shouldn't exist.</p>

            <h4>The Quality & Rework Tax</h4>
            <p>Misunderstandings born from asynchronous communication lead directly to building the wrong thing. Every feature that needs significant rework due to a misread ticket is a 100% tax on the original development time. A single two-week sprint ($20k cost) that has to be redone because the requirements were misunderstood costs you $20k and, more importantly, two weeks of opportunity you'll never get back.</p>

            <h4>The Compliance & Security Risk Multiplier</h4>
            <p>What is the cost of a single data breach? For a mid-stage startup, it's not just the fines; it's existential. Relying on an offshore vendor who allows engineers to use personal laptops without MDM isn't a cost-saving measure; it's a multi-million dollar liability waiting to happen. The cost is not a line item until it is, at which point it's too late. An integrated nearshore model with full device control and contractual liability shifts this risk from your books to ours.</p>
        </div>
