...
export const metadata: Metadata = {
  title: 'Vendor Risk Model & TCO | CTO Playbook | TeamStation AI',
...
export default function VendorRiskModelPage() {
  ...
  return (
    <main className="container py-12">
      <div className="text-sm text-muted-foreground mb-8">
        <Link href="/" className="hover:text-foreground">Home</Link> / <Link href="/playbook/hub" className="hover:text-foreground">CTO Playbook</Link> / <span>Vendor Risk Model</span>
      </div>
      <header className="text-center mb-12">
        <h1 className="text-5xl font-extrabold tracking-tight bg-gradient-to-r from-primary to-blue-400 bg-clip-text text-transparent">Vendor Risk & TCO Model</h1>
        <p className="mt-4 max-w-4xl mx-auto text-lg text-muted-foreground">
          Every vendor sells promises. We provide proof. Here, we move beyond marketing claims to provide a data-driven analysis of Total Cost of Ownership (TCO), operational risk, and true value.
        </p>
      </header>
      ...
      <div className="my-16">
       ...
       <div className="text-center rounded-lg bg-primary/10 p-8 mt-16 shadow-lg">
