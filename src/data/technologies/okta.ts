...
const okta: TechEntry = {
    ...
    pains: [
        ...
        },
        {
            ...
            solution: "Our engineers are masters of **Okta's SSO capabilities**. They are vetted on their ability to configure Okta as a central identity provider and integrate it with your applications using SAML or OIDC, providing a seamless and secure login experience for your users.",
        ...
        },
        {
            ...
            solution: "We look for engineers proficient in **Okta's API Access Management**. They are vetted on their ability to use Okta to secure your APIs with OAuth 2.0, ensuring that only authorized clients can access your data. This results in a more secure and compliant application.",
