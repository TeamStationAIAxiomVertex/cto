    ...
    pains: [
        {
            ...
            solution: "We vet for experts in <strong>custom CodeQL query development</strong>. Our engineers can write sophisticated queries to model your application's data flow and identify unique vulnerabilities, providing a level of security assurance that off-the-shelf tools cannot match.",
            kpi: "Custom Vulnerability Detection with CodeQL"
        },
        {
            iconName: "AlertTriangle",
            pain: "Is your security testing a manual, slow process?",
            problem: "Manual code reviews are time-consuming and can't scale across a large codebase. This means security becomes a bottleneck, and vulnerabilities are often discovered late in the development cycle, when they are most expensive to fix.",
        ...
        },
        {
            ...
            problem: "When a vulnerability is found, fixing the single instance is not enough. The same underlying code pattern often exists elsewhere in the codebase, leaving you vulnerable to the same attack vector in multiple places.",
            solution: "We look for engineers proficient in <strong>variant analysis</strong>. They are vetted on their ability to use CodeQL to write a query for a known vulnerability and then use that query to find all other instances of the same bug across the entire codebase, eliminating entire classes of vulnerabilities at once.",
