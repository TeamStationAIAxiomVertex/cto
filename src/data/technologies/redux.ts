    ...
    pains: [
        {
            ...
            solution: "We vet for experts in **Redux and the modern frontend stack**. Our engineers are proficient in using Redux to build a modern, scalable, and resilient application. This results in a codebase that is easy to understand and a user experience that is a joy to use.",
        ...
        },
        {
            ...
            solution: "Our engineers are masters of **Redux and the modern web**. They are vetted on their ability to use modern web APIs and best practices to build a modern, fast, and feature-rich application. This results in a codebase that is easy to understand and a user experience that is a joy to use.",
