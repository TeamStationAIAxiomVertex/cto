  ...
  pains: [
    {
      ...
      problem:
        "Many teams are not equipped to monitor and observe their systems in production. This can lead to a user experience that is frustrating and a codebase that is hard to maintain and test.",
      solution:
        "We vet for experts in **Prometheus and monitoring**. Our engineers are proficient in using Prometheus to build a modern, observable system. This results in a team that is equipped to monitor and observe their systems in production, and a user experience that is a joy to use for everyone.",
    ...
    },
    {
      ...
      solution:
        "Our engineers are masters of **Prometheus and the modern DevOps ecosystem**. They are vetted on their ability to use Prometheus to build a portable, environment-agnostic application. This results in a codebase that is easy to understand and a user experience that is a joy to use.",
    ...
    },
    {
      ...
      problem:
        "The monitoring ecosystem is vast and powerful, but many teams are not leveraging its full potential. This can lead to a codebase that is a mess of reinvented wheels and a user experience that is not as rich as it could be.",
      solution:
        "We look for engineers proficient with **the monitoring ecosystem and the Prometheus query language**. They are vetted on their ability to build applications that are powered by the best of the monitoring ecosystem. This results in a user experience that is a joy to use for everyone, and a codebase that is easy to maintain and test.",
