  ...
  pains: [
    {
      ...
      problem:
        "In many organizations, the email security platform is a mess of inconsistent, hard-to-maintain policies. This can lead to a user experience that is filled with false positives and a codebase that is a mess of environment-specific hacks and workarounds.",
      solution:
        "We vet for experts in **Proofpoint and the modern security stack**. Our engineers are proficient in using Proofpoint to build a modern, scalable, and resilient email security platform. This results in a codebase that is easy to understand and a user experience that is a joy to use.",
