...
const feast: TechEntry = {
  ...
  meta_description:
    "Hire elite Feast experts specializing in building, managing, and scaling secure, and reliable feature stores.",
  intro:
    "Feast is a powerful and versatile feature store. Our Feast experts are vetted for their deep understanding of Feast's core principles, from its powerful feature definition and serving capabilities to its robust security and performance tuning capabilities. They are the specialists who can help you build and manage a secure, and reliable feature store.",
  pains: [
    {
      icon: AlertTriangle,
      pain: "Our features are a mess of spaghetti code.",
      problem:
        "Poorly managed features are difficult to understand, maintain, and reuse, leading to a lack of confidence in your models.",
      solution:
        "We vet for mastery in **Feast's powerful feature definition and serving capabilities**. Our engineers can help you build a clean, modular, and well-documented feature store.",
    ...
    },
    {
      ...
      problem:
        "The feature store landscape is constantly evolving. It's difficult to keep up with the latest technologies, such as Tecton and Hopsworks.",
      solution:
        "Our experts are tested on **the latest feature store technologies**. They can help you take advantage of the latest features, so you can build the next generation of feature stores.",
    ...
    },
    {
      ...
      solution:
        "We vet for expertise in **Feast's security features**. Our engineers use the latest security best practices to protect your data from attack.",
  ...
  technical_analysis:
    "The Feast vetting process is rigorous and hands-on. Candidates are required to build a production-ready feature store from scratch. We test their ability to write clean, modular, and maintainable code, as well as their understanding of Feast best practices. We also assess their experience with a variety of feature store technologies and their ability to optimize for performance and security.",
