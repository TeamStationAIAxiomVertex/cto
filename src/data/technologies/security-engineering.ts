...
const securityEngineering: TechEntry = {
  ...
  seo_title:
    "Hire Security Engineers | DevSecOps & Application Security Experts",
  meta_description:
  ...
  pains: [
    {
      ...
      problem:
        "In many organizations, the application is a mess of security vulnerabilities and compliance issues. This can lead to a user experience that is filled with data breaches and a codebase that is a mess of environment-specific hacks and workarounds.",
      solution:
        "We vet for experts in **security engineering and the modern DevSecOps stack**. Our engineers are proficient in using tools like Snyk, Veracode, and Checkmarx to build a fully automated, secure, and compliant application. This results in a codebase that is easy to understand and a user experience that is a joy to use.",
