...
const census: TechEntry = {
    ...
    meta_description: "Build a reliable, scalable, and automated data activation platform. Hire elite remote Census experts vetted for their deep understanding of data activation, from the data warehouse to the CRM. Book a call.",
    intro: "Census is a leading data activation platform. You need an engineer who understands that building a modern data activation platform is not just about moving data, but about a deep understanding of the entire data lifecycle, from the data warehouse and the data model to the CRM and the marketing automation platform. Our vetting process identifies developers who are experts in the modern data stack—and can architect a data platform that is as secure, efficient, and automated as it is scalable. By hiring a Census expert, you get a developer who can build a modern, automated, and observable system that is a joy to use, and a joy to maintain.",
    pains: [
        {
            icon: AlertTriangle,
            pain: "Is your data activation platform a mess of brittle, ad-hoc scripts?",
            problem: "In many organizations, the data activation platform is a mess of brittle, ad-hoc scripts. This can lead to a user experience that is filled with stale data and a codebase that is a mess of environment-specific hacks and workarounds.",
            solution: "We vet for experts in **Census and the modern data stack**. Our engineers are proficient in using tools like dbt, Snowflake, and other modern libraries to build a fully automated, reliable, and efficient data activation platform. This results in a codebase that is easy to understand and a user experience that is a joy to use.",
