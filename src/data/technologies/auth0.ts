...
const auth0: TechEntry = {
    ...
    meta_description: "Build a secure, scalable, and modern identity platform. Hire elite remote Auth0 experts vetted for their deep understanding of identity, from the login to the token. Book a call.",
    intro: "Auth0 is a leading identity and access management platform. You need an engineer who understands that building a modern, secure identity platform is not just about writing code, but about a deep understanding of the entire identity ecosystem, from the login and the token to the user and the role. Our vetting process identifies developers who are experts in the modern security stack—and can architect a security platform that is as secure, efficient, and automated as it is scalable. By hiring an Auth0 expert, you get a developer who can build a modern, automated, and observable system that is a joy to use, and a joy to maintain.",
    pains: [
        {
            icon: AlertTriangle,
            pain: "Is your identity platform a mess of inconsistent, hard-to-maintain code?",
            problem: "In many organizations, the identity platform is a mess of inconsistent, hard-to-maintain code. This can lead to a user experience that is filled with security vulnerabilities and a codebase that is a mess of spaghetti code and technical debt.",
            solution: "We vet for experts in **Auth0 and the modern security stack**. Our engineers are proficient in using Auth0 to build a modern, scalable, and resilient identity platform. This results in a codebase that is easy to understand and a user experience that is a joy to use.",
        ...
        },
        {
            ...
            solution: "Our engineers are masters of **Auth0 and the modern web**. They are vetted on their ability to use modern web APIs and best practices to build a modern, fast, and feature-rich application. This results in a codebase that is easy to understand and a user experience that is a joy to use.",
