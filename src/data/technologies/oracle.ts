...
const oracle: TechEntry = {
  ...
  pains: [
    {
      ...
      solution:
        "We vet for experts in **Oracle and the modern data stack**. Our engineers are proficient in using tools like dbt, Airflow, and Spark to build a fully automated, reliable, and efficient data infrastructure. This results in a codebase that is easy to understand and a user experience that is a joy to use.",
  ...
  evaluation: [
    "The modern data stack (e.g., Oracle, dbt, other modern libraries)",
    "Oracle and the modern web",
    "The query and the index",
    "The storage engine and the replication",
    "Security and best practices",
  ],
  technical_analysis:
    "The Oracle evaluation focuses on a candidate's ability to build a scalable, reliable, and secure enterprise data infrastructure. We assess their understanding of the entire Oracle ecosystem, requiring them to design a complex application with a clean, automated, and observable architecture. A critical part of the evaluation is their mastery of **Oracle and the modern data stack**; candidates must demonstrate how to use tools like Oracle, dbt, and other modern libraries to build a modern, scalable, and resilient data infrastructure, and how to use the query and the index to build a read model that is optimized for queries. We also test their ability to build **portable and environment-agnostic** applications that can run on any environment. Finally, we assess their knowledge of the data ecosystem, and their ability to leverage it to build a modern, high-performance backend.",
