...
const mariadb: TechEntry = {
  name: "MariaDB",
  category: "Software Development",
  categorySlug: "software-development",
  seo_title: "Hire MariaDB Experts | Open Source Database & SQL Consultants",
  meta_description:
    "Build a scalable, reliable, and feature-rich data infrastructure. Hire elite remote MariaDB experts vetted for their deep understanding of SQL, from the query to the index. Book a call.",
  intro:
    "MariaDB is a community-developed, commercially supported fork of the MySQL relational database management system. You need an engineer who understands that building a modern, scalable data infrastructure is not just about writing queries, but about a deep understanding of the entire SQL ecosystem, from the query and the index to the storage engine and the replication. Our vetting process identifies developers who are experts in the modern data stack—and can architect a data platform that is as secure, efficient, and automated as it is scalable. By hiring a MariaDB expert, you get a developer who can build a modern, automated, and observable system that is a joy to use, and a joy to maintain.",
  pains: [
    {
      icon: AlertTriangle,
      ...
      solution:
        "We vet for experts in **MariaDB and the modern data stack**. Our engineers are proficient in using tools like dbt, Airflow, and Spark to build a fully automated, reliable, and efficient data infrastructure. This results in a codebase that is easy to understand and a user experience that is a joy to use.",
  ...
  evaluation: [
    "The modern data stack (e.g., MariaDB, dbt, other modern libraries)",
    "MariaDB and the modern web",
    "The query and the index",
    "The storage engine and the replication",
    "Security and best practices",
  ],
  technical_analysis:
    "The MariaDB evaluation focuses on a candidate's ability to build a scalable, reliable, and feature-rich data infrastructure. We assess their understanding of the entire MariaDB ecosystem, requiring them to design a complex application with a clean, automated, and observable architecture. A critical part of the evaluation is their mastery of **MariaDB and the modern data stack**; candidates must demonstrate how to use tools like MariaDB, dbt, and other modern libraries to build a modern, scalable, and resilient data infrastructure, and how to use the query and the index to build a read model that is optimized for queries. We also test their ability to build **portable and environment-agnostic** applications that can run on any environment. Finally, we assess their knowledge of the data ecosystem, and their ability to leverage it to build a modern, high-performance backend.",
