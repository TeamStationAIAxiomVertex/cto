...
const reactNative: TechEntry = {
    ...
    category: "Mobile",
    categorySlug: "mobile",
    seo_title: "Hire React Native Experts | Cross-Platform Mobile & iOS/Android Consultants",
    meta_description: "Build a beautiful, native, and cross-platform mobile application. Hire elite remote React Native experts vetted for their deep understanding of mobile, from the component to the native module. Book a call.",
