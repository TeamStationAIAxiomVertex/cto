...
const astro: TechEntry = {
    ...
    meta_description: "Hire elite Astro developers specializing in building high-performance, scalable, and secure web applications.",
