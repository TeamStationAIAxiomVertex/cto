...
const zustand: TechEntry = {
  ...
  pains: [
    {
      ...
      solution:
        "We vet for experts in **Zustand and the modern frontend stack**. Our engineers are proficient in using Zustand to build a modern, scalable, and resilient application. This results in a codebase that is easy to understand and a user experience that is a joy to use.",
    ...
    },
    {
      ...
      solution:
        "Our engineers are masters of **Zustand and the modern web**. They are vetted on their ability to use modern web APIs and best practices to build a modern, fast, and feature-rich application. This results in a codebase that is easy to understand and a user experience that is a joy to use.",
  ...
  evaluation: [
    "The modern frontend stack (e.g., Zustand, React, other modern libraries)",
    "Zustand and the modern web",
    "The store and the middleware",
    "The action and the reducer",
    "Security and best practices",
  ],
  technical_analysis:
    "The Zustand evaluation focuses on a candidate's ability to build a scalable, maintainable, and reactive application. We assess their understanding of the entire Zustand ecosystem, requiring them to design a complex application with a clean, automated, and observable architecture. A critical part of the evaluation is their mastery of **Zustand and the modern frontend stack**; candidates must demonstrate how to use tools like Zustand, React, and other modern libraries to build a modern, scalable, and resilient application, and how to use the store and the middleware to build a read model that is optimized for queries. We also test their ability to build **portable and environment-agnostic** applications that can run on any environment. Finally, we assess their knowledge of the frontend ecosystem, and their ability to leverage it to build a modern, high-performance backend.",
