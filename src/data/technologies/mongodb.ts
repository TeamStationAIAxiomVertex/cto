  ...
  pains: [
    {
      ...
      solution:
        "We vet for mastery in **MongoDB's powerful data modeling and indexing features**. Our engineers can help you build a fast, and reliable NoSQL database.",
    ...
    },
    {
      ...
      solution:
        "We vet for expertise in **MongoDB's security features**. Our engineers use the latest security best practices to protect your data from attack.",
