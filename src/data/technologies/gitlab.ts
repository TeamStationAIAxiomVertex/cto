...
const gitlab: TechEntry = {
  ...
  meta_description:
    "Build a powerful, all-in-one software delivery platform. Hire elite remote GitLab CI experts vetted for their deep understanding of pipeline configuration, runners, and security. Book a call.",
  intro:
    "GitLab CI/CD is a powerful, integrated tool for building, testing, and deploying software. You need an engineer who can leverage its full potential to create a seamless, end-to-end software delivery pipeline. Our vetting process identifies developers who are experts in the GitLab CI ecosystem, from the `.gitlab-ci.yml` file and runners to the package registry and security scanning. By hiring a GitLab CI expert, you get a developer who can build a modern, automated, and observable system that is a joy to use, and a joy to maintain.",
  pains: [
    {
      icon: AlertTriangle,
      pain: "Is your CI/CD pipeline a mess of disconnected tools and scripts?",
      problem:
        "In many organizations, the CI/CD pipeline is a mess of disconnected tools and scripts. This can lead to a user experience that is filled with bugs and a codebase that is a mess of environment-specific hacks and workarounds.",
      solution:
        "We vet for experts in **GitLab CI and the modern DevOps stack**. Our engineers are proficient in using GitLab CI to build a fully integrated, all-in-one software delivery platform. This results in a codebase that is easy to understand and a user experience that is a joy to use.",
    ...
    },
    {
      ...
      problem:
        "The CI/CD ecosystem is vast and powerful, but many teams are not leveraging its full potential. This can lead to a codebase that is a mess of reinvented wheels and a user experience that is not as rich as it could be.",
      solution:
        "We look for engineers proficient with **the CI/CD ecosystem and the GitLab CI template library**. They are vetted on their ability to build applications that are powered by the best of the CI/CD ecosystem. This results in a user experience that is a joy to use for everyone, and a codebase that is easy to maintain and test.",
