...
const quarkus: TechEntry = {
    ...
    meta_description: "Build a blazing-fast, lightweight, and cloud-native application. Hire elite remote Quarkus experts vetted for their deep understanding of Java, from the CDI container to the native image. Book a call.",
