...
const hightouch: TechEntry = {
  ...
  seo_title:
    "Hire Hightouch Experts | Reverse ETL & Data Activation Consultants",
  meta_description:
  ...
  pains: [
    {
      ...
      problem:
        "Your data warehouse is a goldmine of customer data, but if it's not accessible to your sales, marketing, and success teams, it's not providing any value. This leads to missed opportunities and a disconnected customer experience.",
      solution:
        "We vet for experts in <strong>Reverse ETL and data activation</strong>. Our engineers are proficient in using Hightouch to sync data from your warehouse to your go-to-market tools, empowering your teams with the data they need to drive growth.",
    ...
    },
    {
      ...
      problem:
        "Without a single source of truth for your customer data, it's impossible to build personalized experiences across all your channels. This leads to a fragmented customer journey and a lot of wasted marketing spend.",
      solution:
        "Our engineers are masters of <strong>customer data activation</strong>. They are vetted on their ability to use Hightouch to build a single, unified view of your customer and sync it to all your go-to-market tools, enabling you to build personalized experiences that drive engagement and revenue.",
    ...
    },
    {
      ...
      problem:
        "Building and maintaining custom integrations to sync data from your warehouse to your go-to-market tools is a massive time sink for your data team. This takes them away from higher-value work and slows down your go-to-market teams.",
      solution:
        "We look for engineers proficient with <strong>no-code data integration</strong>. They are vetted on their ability to use Hightouch to build and maintain data syncs without writing any code, freeing up your data team to focus on more strategic initiatives.",
