...
const cpp: TechEntry = {
  ...
  meta_description:
    "Recruit elite C++ developers specializing in systems programming, high-frequency trading, and performance-critical applications.",
  intro:
