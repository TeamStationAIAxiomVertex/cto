...
const redis: TechEntry = {
    ...
    meta_description: "Build a fast, scalable, and resilient application. Hire elite remote Redis experts vetted for their deep understanding of in-memory data stores, from caching to real-time data. Book a call.",
