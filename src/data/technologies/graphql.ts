...
const graphql: TechEntry = {
  ...
  pains: [
    {
      ...
      solution:
        "We vet for mastery in **GraphQL's powerful query language**. Our engineers can help you build a fast, and efficient API.",
    ...
    },
    {
      ...
      problem:
        "The API landscape is constantly evolving. It's difficult to keep up with the latest technologies, such as gRPC and WebSockets.",
      solution:
    ...
    },
    {
      ...
      solution:
        "We vet for expertise in **GraphQL's security features**. Our engineers use the latest security best practices to protect your APIs from attack.",
  ...
  technical_analysis:
    "The GraphQL vetting process is rigorous and hands-on. Candidates are required to build a production-ready API with GraphQL from scratch. We test their ability to write clean, modular, and maintainable code, as well as their understanding of GraphQL best practices. We also assess their experience with a variety of API technologies and their ability to optimize for performance and security.",
  interlink_slugs: [
    "apollo",
    "relay",
    "graphql-yoga",
