...
const penetrationTesting: TechEntry = {
    ...
    pains: [
        {
            ...
            solution: "We vet for experts in **penetration testing and the modern DevSecOps stack**. Our engineers are proficient in using tools like Metasploit, Burp Suite, and Nmap to build a fully automated, secure, and compliant application. This results in a codebase that is easy to understand and a user experience that is a joy to use.",
    ...
    technical_analysis: "The Penetration Testing evaluation focuses on a candidate's ability to build a secure, resilient, and compliant application. We assess their understanding of the entire threat landscape, requiring them to design a complex application with a clean, automated, and observable architecture. A critical part of the evaluation is their mastery of **the modern DevSecOps stack and penetration testing**; candidates must demonstrate how to use tools like Metasploit, Burp Suite, and Nmap to build a fully automated, secure, and compliant application, and how to use penetration testing to identify and mitigate security risks. We also test their ability to build **secure and compliant** applications that can run on any environment. Finally, we assess their knowledge of the security ecosystem, and their ability to leverage it to build a modern, high-performance backend.",
