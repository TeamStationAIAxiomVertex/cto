...
const express: TechEntry = {
  ...
  pains: [
    {
      ...
      solution:
        "We vet for mastery in **Express's powerful routing and middleware**. Our engineers can help you build a website that is fast, scalable, and cost-effective.",
    ...
    },
    {
      ...
      solution:
        "Our experts are tested on **Express's growing ecosystem of integrations**. They can help you take advantage of the latest web technologies, so you can build the next generation of web applications.",
    ...
    },
    {
      ...
      solution:
        "We vet for expertise in **Express's security features**. Our engineers use the latest security best practices to protect your website from attack.",
  ...
  technical_analysis:
    "The Express vetting process is rigorous and hands-on. Candidates are required to build a production-ready web application with Express from scratch. We test their ability to write clean, modular, and maintainable code, as well as their understanding of Express best practices. We also assess their experience with a variety of Express integrations and their ability to optimize for performance and security.",
