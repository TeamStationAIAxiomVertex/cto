...
const apollo: TechEntry = {
  ...
  pains: [
    ...
    },
    {
      ...
      problem:
        "Managing client-side state is one of the biggest challenges in modern frontend development. Without a clear strategy, your state can quickly become a tangled mess of different libraries and patterns, making your application hard to reason about and debug.",
      solution:
        "Our engineers are experts in managing client-side state with Apollo. We vet for a deep understanding of how to use Apollo Client as a single source of truth for all of your data, both remote and local. They can help you build a clean, predictable, and maintainable state management solution that will make your application a pleasure to work on.",
    ...
    },
    {
      ...
      problem:
        "Building a real-time application with a complex UI is a challenge. You need to manage a lot of moving parts, and it's easy to end up with a slow, buggy, and unreliable application. This is a common problem for developers who are new to the world of real-time data.",
      solution:
        "We find engineers who are experts in building real-time applications with Apollo. They are skilled in using Apollo's subscriptions to build a resilient and scalable real-time data layer. They can help you build a fast, reliable, and engaging application that your users will love.",
