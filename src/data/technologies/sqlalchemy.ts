  ...
  pains: [
    {
      ...
      problem:
        "In many organizations, the data access layer is a mess of slow, inefficient queries. This can lead to a user experience that is filled with stale data and a codebase that is a mess of environment-specific hacks and workarounds.",
      solution:
        "We vet for experts in <strong>SQLAlchemy and the modern data stack</strong>. Our engineers are proficient in using tools like dbt, Airflow, and Spark to build a fully automated, reliable, and efficient data access layer. This results in a codebase that is easy to understand and a user experience that is a joy to use.",
