  ...
  pains: [
    {
      ...
      solution:
        "We vet for experts in **REST and the modern API stack**. Our engineers are proficient in using tools like Swagger, OpenAPI, and Postman to build a modern, developer-friendly API. This results in a codebase that is easy to understand and a developer experience that is a joy to use.",
    ...
    },
    {
      ...
      solution:
        "Our engineers are masters of **REST and the modern web**. They are vetted on their ability to use modern web APIs and best practices to build a modern, fast, and feature-rich application. This results in a codebase that is easy to understand and a user experience that is a joy to use.",
