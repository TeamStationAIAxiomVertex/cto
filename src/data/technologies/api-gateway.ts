...
const apiGateway: TechEntry = {
  ...
  meta_description:
    "Hire elite API Gateway experts specializing in building, managing, and scaling secure, and reliable API gateways.",
  intro:
    "API Gateway is a critical component of any modern, microservices-based architecture. Our API Gateway experts are vetted for their deep understanding of API Gateway's core principles, from its powerful routing and caching features to its robust security and throttling capabilities. They are the specialists who can help you build and manage a secure, and reliable API gateway.",
  pains: [
    {
      icon: AlertTriangle,
      pain: "Our APIs are slow and unreliable.",
      problem:
        "Poorly designed APIs are a bottleneck for your entire system. They are difficult to scale, and can lead to a poor user experience.",
      solution:
        "We vet for mastery in **API Gateway's powerful routing and caching features**. Our engineers can help you build a fast, and reliable API gateway.",
    ...
    },
    {
      ...
      problem:
        "The API landscape is constantly evolving. It's difficult to keep up with the latest technologies, such as GraphQL and gRPC.",
      solution:
    ...
    },
    {
      ...
      solution:
        "We vet for expertise in **API Gateway's security features**. Our engineers use the latest security best practices to protect your APIs from attack.",
