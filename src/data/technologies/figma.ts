...
const figma: TechEntry = {
  ...
  meta_description:
    "Hire elite Figma experts specializing in building, managing, and scaling secure, and reliable design systems.",
  intro:
  ...
  pains: [
    {
      ...
      problem:
        "Poorly designed design systems are difficult to understand, maintain, and reuse, leading to a lack of confidence in your product.",
      solution:
        "We vet for mastery in **Figma's powerful design and prototyping features**. Our engineers can help you build a clean, modular, and well-documented design system.",
    ...
    },
    {
      ...
      problem:
        "The design and prototyping landscape is constantly evolving. It's difficult to keep up with the latest technologies, such as Framer and Sketch.",
      solution:
        "Our experts are tested on **the latest design and prototyping technologies**. They can help you take advantage of the latest features, so you can build the next generation of design systems.",
    ...
    },
    {
      ...
      solution:
        "We vet for expertise in **Figma's security features**. Our engineers use the latest security best practices to protect your data from attack.",
  ...
  technical_analysis:
    "The Figma vetting process is rigorous and hands-on. Candidates are required to build a production-ready design system from scratch. We test their ability to write clean, modular, and maintainable code, as well as their understanding of Figma best practices. We also assess their experience with a variety of design and prototyping technologies and their ability to optimize for performance and security.",
