...
const flask: TechEntry = {
  ...
  pains: [
    {
      ...
      solution:
        "We vet for mastery in **Flask's powerful routing and templating**. Our engineers can help you build a website that is fast, scalable, and cost-effective.",
    ...
    },
    {
      ...
      solution:
        "Our experts are tested on **Flask's growing ecosystem of integrations**. They can help you take advantage of the latest web technologies, so you can build the next generation of web applications.",
    ...
    },
    {
      ...
      solution:
        "We vet for expertise in **Flask's security features**. Our engineers use the latest security best practices to protect your website from attack.",
  ...
  technical_analysis:
    "The Flask vetting process is rigorous and hands-on. Candidates are required to build a production-ready web application with Flask from scratch. We test their ability to write clean, modular, and maintainable code, as well as their understanding of Flask best practices. We also assess their experience with a variety of Flask integrations and their ability to optimize for performance and security.",
