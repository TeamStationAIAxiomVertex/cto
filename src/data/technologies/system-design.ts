...
const systemDesign: TechEntry = {
    ...
    seo_title: "Hire System Design Experts | Distributed Systems & Software Architecture Consultants",
    meta_description: "Build a scalable, resilient, and maintainable application. Hire elite remote system design experts vetted for their deep understanding of distributed systems, from the load balancer to the database. Book a call.",
    ...
    pains: [
        {
            ...
            solution: "We vet for experts in **system design and distributed systems**. Our engineers are proficient in using tools like Kubernetes, Istio, and Linkerd to build a modern, scalable, and resilient system. This results in a codebase that is easy to understand and a user experience that is a joy to use.",
