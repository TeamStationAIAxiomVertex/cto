...
const kubernetes: TechEntry = {
    ...
    seo_title: "Hire Senior Kubernetes Experts | Certified Kubernetes Administrators (CKA)",
    meta_description: "Hire elite Kubernetes experts specializing in designing, building, and managing scalable, resilient, and secure containerized infrastructure on any cloud.",
    ...
    technical_analysis: "The Kubernetes vetting process is rigorous and hands-on. Candidates are required to build a secure, multi-tenant Kubernetes cluster from scratch, and then deploy a complex microservices application to it. We test their ability to troubleshoot common cluster issues, such as networking problems and storage failures. We also assess their understanding of Kubernetes security best practices, including how to secure the control plane, worker nodes, and container images.",
