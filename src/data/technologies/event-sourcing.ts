...
const eventSourcing: TechEntry = {
  ...
  seo_title:
    "Hire Senior Event Sourcing Experts | Event-Driven Architecture Specialists",
  meta_description:
    "Hire elite Event Sourcing experts specializing in building, managing, and scaling secure, and reliable event-driven systems.",
  intro:
    "Event Sourcing is a powerful and versatile event-driven architecture pattern. Our Event Sourcing experts are vetted for their deep understanding of Event Sourcing's core principles, from its powerful event store to its robust security and performance tuning capabilities. They are the specialists who can help you build and manage a secure, and reliable event-driven system.",
  pains: [
    {
      icon: AlertTriangle,
      ...
      solution:
        "We vet for mastery in **Event Sourcing's powerful event store**. Our engineers can help you build a clean, modular, and well-documented event-driven system.",
    ...
    },
    {
      ...
      problem:
        "The event-driven landscape is constantly evolving. It's difficult to keep up with the latest technologies, such as Kafka and RabbitMQ.",
      solution:
        "Our experts are tested on **the latest event-driven technologies**. They can help you take advantage of the latest features, so you can build the next generation of event-driven systems.",
    ...
    },
    {
      ...
      solution:
        "We vet for expertise in **Event Sourcing's security features**. Our engineers use the latest security best practices to protect your data from attack.",
