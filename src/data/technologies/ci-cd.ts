...
const ciCd: TechEntry = {
  ...
  seo_title:
    "Hire Senior CI/CD Engineers | Automation and Pipeline Specialists",
  meta_description:
    "Hire elite CI/CD engineers specializing in building, managing, and scaling secure, and reliable software delivery pipelines.",
  intro:
    "CI/CD is a critical component of any modern, software development lifecycle. Our CI/CD experts are vetted for their deep understanding of CI/CD's core principles, from its powerful pipeline-as-code features to its robust security and performance testing capabilities. They are the specialists who can help you build and manage a secure, and reliable software delivery pipeline.",
  pains: [
    {
      icon: AlertTriangle,
      ...
      solution:
        "We vet for mastery in **CI/CD's powerful pipeline-as-code features**. Our engineers can help you build a fast, and reliable software delivery pipeline.",
    ...
    },
    {
      ...
      problem:
        "The CI/CD landscape is constantly evolving. It's difficult to keep up with the latest technologies, such as GitOps and DevSecOps.",
      solution:
        "Our experts are tested on **the latest CI/CD technologies**. They can help you take advantage of the latest features, so you can build the next generation of software delivery pipelines.",
    ...
    },
    {
      ...
      solution:
        "We vet for expertise in **CI/CD's security features**. Our engineers use the latest security best practices to protect your software from attack.",
  ...
  technical_analysis:
    "The CI/CD vetting process is rigorous and hands-on. Candidates are required to build a production-ready software delivery pipeline from scratch. We test their ability to write clean, modular, and maintainable code, as well as their understanding of CI/CD best practices. We also assess their experience with a variety of CI/CD technologies and their ability to optimize for performance and security.",
  interlink_slugs: [
    "jenkins",
    "gitlab",
    "github-actions",
