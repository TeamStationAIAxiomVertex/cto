...
const terraform: TechEntry = {
  ...
  seo_title:
    "Hire Senior Terraform Experts | Infrastructure as Code (IaC) Specialists",
  meta_description:
    "Hire elite Terraform experts specializing in building, managing, and scaling immutable infrastructure across all major cloud providers.",
  intro:
  ...
  pains: [
    {
      ...
      problem:
        "Poorly written Terraform code is difficult to understand, maintain, and reuse, leading to configuration drift and a lack of confidence in your infrastructure.",
      solution:
        "We vet for mastery in **Terraform best practices**. Our engineers write clean, modular, and well-documented code that is easy to understand, maintain, and reuse.",
    ...
    },
    {
      ...
      solution:
        "Our experts are tested on **multi-cloud deployments**. They use Terraform to create a single, unified workflow for managing infrastructure across all major cloud providers.",
    ...
    },
    {
      ...
      solution:
        "We vet for expertise in building **immutable infrastructure**. Our engineers use Terraform to create a version-controlled, auditable, and reproducible infrastructure that can be deployed with confidence.",
  ...
  technical_analysis:
    "The Terraform vetting process is rigorous and hands-on. Candidates are required to write Terraform code to provision a complex, multi-cloud infrastructure from scratch. We test their ability to write clean, modular, and maintainable code, as well as their understanding of Terraform best practices. We also assess their experience with building and managing CI/CD pipelines for Terraform, and their ability to write and use Terraform modules.",
