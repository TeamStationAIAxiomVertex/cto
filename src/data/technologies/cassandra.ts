...
const cassandra: TechEntry = {
  ...
  pains: [
    {
      ...
      solution:
        "We vet for mastery in **Cassandra's powerful data modeling and partitioning features**. Our engineers can help you build a fast, and reliable distributed database.",
    ...
    },
    {
      ...
      problem:
        "The database landscape is constantly evolving. It's difficult to keep up with the latest technologies, such as NoSQL and NewSQL.",
      solution:
    ...
    },
    {
      ...
      solution:
        "We vet for expertise in **Cassandra's security features**. Our engineers use the latest security best practices to protect your data from attack.",
  ...
  technical_analysis:
    "The Cassandra vetting process is rigorous and hands-on. Candidates are required to build a production-ready distributed database from scratch. We test their ability to write clean, modular, and maintainable code, as well as their understanding of Cassandra best practices. We also assess their experience with a variety of database technologies and their ability to optimize for performance and security.",
