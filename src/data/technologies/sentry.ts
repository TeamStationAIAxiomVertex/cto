...
const sentry: TechEntry = {
  ...
  meta_description:
    "Go beyond logs. Hire elite remote Sentry experts vetted for their deep understanding of error tracking, performance monitoring, and release health. Book a call.",
  intro:
    "Sentry is an essential tool for modern application monitoring, providing deep insights into errors and performance bottlenecks in your code. You need an engineer who can leverage Sentry to its full potential, transforming it from a simple error bucket into a proactive tool for improving code quality and user experience. Our vetting process identifies developers who are experts in configuring Sentry SDKs, setting up effective alerting, and using Sentry's performance monitoring to diagnose and fix real-world issues. By hiring a Sentry expert, you get a developer who can help you ship faster with more confidence.",
  pains: [
    {
      icon: AlertTriangle,
      pain: "Are you discovering bugs from user complaints instead of proactive alerts?",
      problem:
        "Relying on users to report bugs is a poor strategy. By the time a user complains, the issue has already caused a negative experience, damaged your brand's reputation, and potentially resulted in lost revenue. You are flying blind in production.",
      solution:
        "We vet for experts in <strong>proactive error monitoring</strong>. Our engineers are proficient in instrumenting applications with the Sentry SDK and configuring intelligent alerting rules that notify your team of critical errors in real-time, often before users even notice there's a problem.",
    ...
    },
    {
      ...
      problem:
        "A poorly configured Sentry project can quickly become overwhelmed with low-impact or duplicate errors, creating alert fatigue. When everything is an emergency, nothing is. Developers start ignoring alerts, and critical issues get lost in the noise.",
      solution:
        "Our engineers are masters of <strong>Sentry project configuration and workflow</strong>. They are vetted on their ability to use ownership rules, issue grouping, and alert filtering to ensure that the right alerts get to the right team at the right time, turning a noisy inbox into an actionable task list.",
    ...
    },
    {
      ...
      problem:
        "Backend performance metrics are not enough. Without visibility into frontend performance, you can't understand how your application is actually behaving for real users. You might have slow page loads, janky animations, or rage clicks that you are completely unaware of.",
      solution:
        "We look for engineers proficient in <strong>Sentry's performance monitoring and session replay</strong>. They are vetted on their ability to analyze Core Web Vitals, identify frontend performance bottlenecks, and use session replays to understand the real user experience, providing a complete picture of your application's health.",
