...
export const NAV: NavSections = {
  Playbook: [
    ...
    { href: '/playbook/cto-outsourcing-risk-mitigation', label: 'Outsourcing Risk Mitigation', description: 'A data-driven guide to de-risking your outsourcing strategy.' },
