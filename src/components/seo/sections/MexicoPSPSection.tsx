...
export default function MexicoPSPSection() {
  const items: PainPoint[] = [
    ...
    },
    {
      ...
      solution:
        "Hire for product fluency. Mexico leads facilitate refinement, capture decisions in ADRs, and protect contracts with tests.",
    ...
    },
    {
      ...
      solution:
        "QA in the pod. Test design begins at refinement; UI/API/contract suites gate merges and deployments.",
    ...
    },
    {
      ...
      solution:
        "Stable pods with named owners. We document flows, keep decision logs, and rotate responsibly with shadowing.",
  ...
  return (
    <section className="mt-12">
      <header className="prose dark:prose-invert max-w-none">
        ...
        <p>
          If offshore is a long-distance relationship, Mexico is a next-door
          neighbor with a spare key. Overlap isn’t a perk; it’s the mechanism
          that collapses feedback loops, keeps PRs moving, and prevents tiny
          questions from snowballing into week-long detours. You get real-time
          refinement, fewer surprises, and a release plan that survives contact
          with reality.
        </p>
        <p>
          ...
          inheriting a compliance hangover.
        </p>
      </header>
      ...
      <footer className="prose dark:prose-invert max-w-none mt-10">
        ...
        <p>
          Begin with a thin slice. One pod, one user journey, one measurable
        ...
        <p>
          Next reads:{" "}
          <Link href="/playbook/latam-economics">LATAM Economics</Link>,{" "}
