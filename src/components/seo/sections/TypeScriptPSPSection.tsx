  ...
  const items: PainPoint[] = [
    {
      ...
      solution: "Narrow types at the edges, validate at runtime, and enforce strictness with lint + CI. Contract tests protect API shapes.",
    ...
    },
    {
      ...
      solution: "Own the boundary. Keep islands tiny, server by default, and prove it in CI with boundary lint checks.",
    ...
    },
    {
      ...
      solution: "Adopt a lightweight platform standard: path aliases, strict tsconfig, ESLint rules for imports, and PR templates.",
    ...
    },
    {
      ...
      solution: "Layer tests deliberately: contracts for API boundaries, component tests for UX, light e2e for journeys.",
    ...
    },
    {
      ...
      solution: "Centralize config with typed schemas, defaults, and environment matrices checked at startup.",
    ...
    },
    {
      ...
      solution: "Standardize data-fetch + cache (TanStack, SWR, RTK Query), isolate state, and prefetch with intent.",
    ...
    },
    {
      ...
      solution: "Bake a11y into components. Use headless UI patterns, keyboard traps tested, and color-contrast lint.",
    ...
    },
    {
      ...
      solution: "Adopt OpenTelemetry from day one. Trace user journeys, tag releases, sample intelligently.",
    ...
    },
    {
      ...
      solution: "Own your topology: clear boundaries, independent versioning or changesets, prebuilt artifacts, owners per package.",
    ...
    },
    {
      ...
      solution: "Feature flags, progressive delivery, and a paved release path. Move fast inside guardrails.",
