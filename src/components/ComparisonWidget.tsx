...
import { WithTooltip } from "./client/tooltip-hook";
...
export default function ComparisonWidget() {
  ...
  const [nearshoreLegacyOverhead, setNearshoreLegacyOverhead] = useState(0.1);
  const [onshoreOverhead, setOnshoreOverhead] = useState(0.2);
