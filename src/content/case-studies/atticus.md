...
challenge: "A non-functional monolithic POC and a 3-month MVP deadline for a regulated, data-sensitive application on a lean budget."
outcomes: "$550K in estimated development cost savings and a production-ready app in the App Store in under 6 months."
canonical: 'https://cto.teamstation.dev/case-studies/atticus'
ogImage:
  src:
    url: "https://images.unsplash.com/photo-1590402494562-4b788beb429e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxNnx8cHJvZHVjdCUyMHRlYW0lMjB8ZW58MHx8fHwxNzU5Mjg0MzY5fDA&ixlib=rb-4.1.0&q=80&w=1080"
  aiHint: "legal tech"
techStack:
  - name: 'PHP/Laravel'
