...
const PAGES = [
  {
    file: "src/app/services/integrated-services/page.tsx",
...
`,
  },
  {
    ...
    content: `// NOTE: this file is a Server Component (no 'use client')
import 'server-only';
...
`,
  },
  {
    ...
    content: `import { permanentRedirect } from 'next/navigation'
