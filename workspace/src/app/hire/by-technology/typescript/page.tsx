...
import TypeScriptPSPSection from "../../../../../../src/components/seo/sections/TypeScriptPSPSection";
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 3,
        name: tech.name,
        item: `${siteUrl}/hire/by-technology/typescript`,
      },
    ],
  };
